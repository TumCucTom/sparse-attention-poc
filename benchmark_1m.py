#!/usr/bin/env python3
"""Benchmark Qwen2.5-14B sparse at 1M context."""
import os
import torch
...
print("Benchmarking sparse at 1M...")
times = []
for i in range(3):
    ...
    try:
        ...
        print(f"  Iter {i+1}: {speed:.2f} tok/s ({elapsed:.2f}s) mem={mem:.1f}GB")
    except Exception as e:
...
os.makedirs("hpc_results_1m", exist_ok=True)
with open("hpc_results_1m/sparse_1m.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 1M: {avg_speed:.2f} tok/s")

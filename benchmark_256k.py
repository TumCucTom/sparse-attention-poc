#!/usr/bin/env python3
"""Benchmark Qwen2.5-14B sparse at 256K context."""
import os
import torch
...
print("Benchmarking sparse at 256K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_256k", exist_ok=True)
with open("hpc_results_256k/sparse_256k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 256K: {avg_speed:.1f} tok/s")

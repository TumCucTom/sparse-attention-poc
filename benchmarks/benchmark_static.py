#!/usr/bin/env python3
"""Benchmark static block selection on Qwen2.5-14B at 128K context."""
import os
import torch
from transformers import AutoModelForCausalLM, AutoTokenizer
import time
import json
from minimax_m3_static import StaticBlockSparseAttention
import types
...
# Use window_size=128 (last 128 tokens to attend to)
window_size = 128
...
print("Benchmarking static selection at 128K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_static", exist_ok=True)
with open("hpc_results_static/static_128k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nStatic at 128K: {avg_speed:.1f} tok/s")

#!/usr/bin/env python3
"""Benchmark sparse on Qwen2.5-14B at 131K context."""
import os
import torch
...
print("Benchmarking sparse at 128K...")
times = []
for i in range(3):
...
with open(f"hpc_results_qwen14b_sparse/sparse_128k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 128K: {avg_speed:.1f} tok/s")

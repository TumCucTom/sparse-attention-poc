#!/usr/bin/env python3
"""Benchmark Qwen2.5-14B sparse at 512K context."""
import os
import torch
...
def replace(module):
    if isinstance(module, Qwen2Attention):
        ...
        attn = MiniMaxSparseAttention(
            ...
            block_size=32,
            top_k_blocks=4,
            index_dim=16,  # Use smaller index_dim
...
print("Benchmarking sparse at 512K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_512k", exist_ok=True)
with open("hpc_results_512k/sparse_512k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 512K: {avg_speed:.1f} tok/s")

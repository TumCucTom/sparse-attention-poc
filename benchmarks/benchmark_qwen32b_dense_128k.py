#!/usr/bin/env python3
"""Benchmark dense on Qwen2.5-32B at 128K context."""
import os
import torch
...
os.makedirs("hpc_results_qwen32b_dense", exist_ok=True)
with open(f"hpc_results_qwen32b_dense/dense_128k.json", 'w') as f:

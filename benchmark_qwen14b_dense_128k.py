#!/usr/bin/env python3
"""Benchmark dense on Qwen2.5-14B at 128K context for comparison."""
import os
import torch
...
prompt = base_prompt * 30000  # Should give ~128K tokens
...
print("Benchmarking dense at 128K...")
times = []
for i in range(3):
...
with open(f"hpc_results_qwen14b_dense/dense_128k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nDense at 128K: {avg_speed:.1f} tok/s")

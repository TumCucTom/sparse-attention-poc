#!/usr/bin/env python3
"""Benchmark Qwen2.5-14B dense at 256K context."""
import os
import torch
...
print("Benchmarking dense at 256K...")
times = []
for i in range(3):
...
with open("hpc_results_256k/dense_256k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nDense at 256K: {avg_speed:.1f} tok/s")

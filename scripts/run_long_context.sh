#!/bin/bash
#SBATCH --job-name=long-context-test
#SBATCH --output=logs/long-context-%j.out
#SBATCH --error=logs/long-context-%j.err
...
echo "=========================================="
echo "Long Context Scaling Test"
echo "=========================================="
...
OUTPUT_DIR="hpc_results_long_context"
mkdir -p "$OUTPUT_DIR"

# Test Qwen2.5-7B with dense vs sparse at long context lengths
MODEL="Qwen/Qwen2.5-7B"

echo ""
echo "=== Testing Long Context Scaling (Dense vs Sparse) ==="

# Dense tests at increasing context lengths
...
# Sparse tests at long context lengths

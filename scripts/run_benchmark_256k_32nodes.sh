#!/bin/bash
#SBATCH --job-name=minimax-dense-256k-32n
#SBATCH --output=logs/benchmark_dense_256k_32n_%j.out
#SBATCH --error=logs/benchmark_dense_256k_32n_%j.err
...
echo ""
echo "=== Running MiniMax-M2.7 DENSE at 256K on 32 nodes ==="

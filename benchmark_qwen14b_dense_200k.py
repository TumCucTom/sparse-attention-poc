#!/usr/bin/env python3
"""Benchmark dense on Qwen2.5-14B at 200K context for comparison."""
import os
import torch
...
prompt = base_prompt * 45000  # Should give ~200K tokens
...
print("Benchmarking dense at 200K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_qwen14b_dense", exist_ok=True)
with open(f"hpc_results_qwen14b_dense/dense_200k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nDense at 200K: {avg_speed:.1f} tok/s")

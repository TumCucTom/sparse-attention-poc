#!/usr/bin/env python3
"""Benchmark Mixtral MoE dense at 64K context."""
import os
import torch
...
print("Benchmarking Mixtral dense at 64K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_mixtral_dense", exist_ok=True)
with open("hpc_results_mixtral_dense/dense_64k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nMixtral dense at 64K: {avg_speed:.1f} tok/s")

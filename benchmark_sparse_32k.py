#!/usr/bin/env python3
"""Benchmark sparse vs dense at 32K context."""
import os
import torch
...
with open("hpc_results_sparse_v2/sparse_32k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 32K: {avg_speed:.1f} tok/s")

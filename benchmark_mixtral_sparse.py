#!/usr/bin/env python3
"""Benchmark Mixtral MoE with sparse attention at 64K context."""
import os
import torch
...
print("Benchmarking Mixtral sparse at 64K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_mixtral_sparse", exist_ok=True)
with open("hpc_results_mixtral_sparse/sparse_64k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nMixtral sparse at 64K: {avg_speed:.1f} tok/s")

#!/usr/bin/env python3
"""Benchmark Qwen2.5-7B sparse at 128K context."""
import os
import torch
...
os.makedirs("hpc_results_qwen7b_sparse", exist_ok=True)
with open("hpc_results_qwen7b_sparse/sparse_128k.json", 'w') as f:

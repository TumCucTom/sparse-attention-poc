#!/usr/bin/env python3
"""Benchmark sliding window on Qwen2.5-14B at 64K context."""
import os
import torch
from transformers import AutoModelForCausalLM, AutoTokenizer
import time
import json
from streaming_attention import StreamingLocalAttention
import types
...
os.makedirs("hpc_results_qwen14b_sliding", exist_ok=True)
with open(f"hpc_results_qwen14b_sliding/sliding_64k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSliding window at 64K: {avg_speed:.1f} tok/s")

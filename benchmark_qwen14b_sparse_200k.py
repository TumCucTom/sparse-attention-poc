#!/usr/bin/env python3
"""Benchmark sparse on Qwen2.5-14B at 200K context."""
import os
import torch
...
print("Benchmarking sparse at 200K...")
times = []
for i in range(3):
...
os.makedirs("hpc_results_qwen14b_sparse", exist_ok=True)
with open(f"hpc_results_qwen14b_sparse/sparse_200k.json", 'w') as f:
    json.dump(result, f, indent=2)

print(f"\nSparse at 200K: {avg_speed:.1f} tok/s")
